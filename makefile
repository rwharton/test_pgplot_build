...
SRC=../pgplot
SRCDIR=../pgplot/src
OBSDIR=../pgplot/obssrc
DEMDIR=../pgplot/examples
FNTDIR=../pgplot/fonts
DRVDIR=../pgplot/drivers
SYSDIR=../pgplot/sys_linux
PGDDIR=../pgplot/pgdispd
GENDIR=../pgplot/sys
XMDIR=../pgplot/drivers/xmotif
XADIR=../pgplot/drivers/xathena
TKDIR=../pgplot/drivers/xtk
#
...
MOTIF_LIBS=-lXm -lXt -L/usr/X11R6/lib -lX11 `$(SRC)/cpg/libgcc_path.sh` -lgcc -lm -lc
ATHENA_LIBS=-lXaw -lXt -lXmu -lXext -L/usr/X11R6/lib -lX11 `$(SRC)/cpg/libgcc_path.sh` -lgcc -lm -lc
TK_LIBS=-L/usr/lib -ltk -ltcl -L/usr/X11R6/lib -lX11 `$(SRC)/cpg/libgcc_path.sh` -lgcc -lm -lc -ldl
#
...
DRIVERS=nudriv.o psdriv.o xwdriv.o 
...
pgplot.doc: $(PG_SOURCE)
	../pgplot/makedoc $(PG_SOURCE) > pgplot.doc
pgplot.html: $(PG_SOURCE)
	../pgplot/makehtml $(PG_SOURCE) > pgplot.html
pgplot.hlp: $(PG_SOURCE)
	../pgplot/makehelp $(PG_SOURCE) > pgplot.hlp
pgplot-routines.tex: $(PG_SOURCE)
	../pgplot/maketex $(PG_SOURCE) > pgplot-routines.tex
